                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-daterange datepicker row align-items-center">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label"><?php echo e(__('Last Status')); ?></label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="<?php echo e($st->alias); ?>" <?php if(isset($_GET['status']) && $_GET['status'] == $st->alias){echo 'selected';} ?>><?php echo e($st->name); ?></option>
...
</div><?php /**PATH /var/www/html/qrcode/resources/views/orders/partials/ordercard.blade.php ENDPATH**/ ?>