                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="row">
                            ...
                            <div class="col-sm col-md col-lg col-lg" id="modalItemDetailsPart">
                                ...
                                <br>
                                <label class="form-control-label" for="ingredientDescription"><?php echo e(__('Ingredients')); ?></label>
...
<?php /**PATH /var/www/html/qrcode/resources/views/restorants/partials/modals.blade.php ENDPATH**/ ?>