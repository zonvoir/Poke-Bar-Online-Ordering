...
<?php if($field['ftype']=="duration"): ?>
        <?php echo $__env->make('partials.duration',$field, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /var/www/html/qrcode/resources/views/partials/fields.blade.php ENDPATH**/ ?>